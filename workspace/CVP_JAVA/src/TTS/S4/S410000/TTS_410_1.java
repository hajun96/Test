package TTS.S4.S410000;

import com.audium.server.AudiumException;
import com.audium.server.session.ActionElementData;
import com.audium.server.voiceElement.ActionElementBase;

public class TTS_410_1 extends ActionElementBase{
	public void doAction(String name, ActionElementData actionAPI) throws AudiumException {
		...
		*/
		...
		String m_strBalAssmDepAsstAmt = (String) actionAPI.getSessionData("m_strBalAssmDepAsstAmt"); //추정예탁자산
		m_strBalAssmDepAsstAmt = trimNum(m_strBalAssmDepAsstAmt);
		Float f_m_strBalAssmDepAsstAmt = Float.parseFloat(m_strBalAssmDepAsstAmt);
		...
		if(f_m_strBalAssmDepAsstAmt != 0.0){
			sb.append(", 추정예탁자산은, ")
			.append(m_strBalAssmDepAsstAmt)
			.append(", 원 ,");
		}else{
			sb.append(", 추정예탁자산은, ")
			.append(", 없고 ,");
