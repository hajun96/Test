...
public class TTS_410_2 extends ActionElementBase{
	public void doAction(String name, ActionElementData actionAPI) throws AudiumException {
		...
		String m_strBalAvgUprc = (String) actionAPI.getSessionData("m_strBalAvgUprc"); //평균단가
		m_strBalAvgUprc = trimNum(m_strBalAvgUprc);
