	...
	public void doAction(String name, ActionElementData actionAPI) throws AudiumException {
		...
		if(m_strBalCrdtSect.equals("0") || m_strBalCrdtSect.equals("") || m_strBalCrdtSect.equals(null)){
			...
			if(m_strBalCrdtSect.equals("현금")){
				sb.append("현금").append(m_strBalItemVol).append(", 주, 입니다.");
			}else if(m_strBalCrdtSect.equals("유융")){
				sb.append("유통융자").append(m_strBalItemVol).append(", 주, 입니다.");
			}else if(m_strBalCrdtSect.equals("자융")){
				sb.append("자기융자").append(m_strBalItemVol).append(", 주, 입니다.");
			}else if(m_strBalCrdtSect.equals("유대")){
				sb.append("유통대주").append(m_strBalItemVol).append(", 주, 입니다.");
			}else if(m_strBalCrdtSect.equals("일담")){
				sb.append("일반담보대출").append(m_strBalItemVol).append(", 주, 입니다.");
			}else if(m_strBalCrdtSect.equals("자대")){
				sb.append("자기대주").append(m_strBalItemVol).append(", 주, 입니다.");
			}else if(m_strBalCrdtSect.equals("대차")){
				sb.append("신용대차").append(m_strBalItemVol).append(", 주, 입니다.");
			}else if(m_strBalCrdtSect.equals("매입")){
				sb.append("매입자금대출").append(m_strBalItemVol).append(", 주, 입니다.");
			}else if(m_strBalCrdtSect.equals("매도")){
				sb.append("매도자금담보대출").append(m_strBalItemVol).append(", 주, 입니다.");
			}else if(m_strBalCrdtSect.equals("대용")){
				sb.append("대용미수금").append(m_strBalItemVol).append(", 주, 입니다.");
			}else if(m_strBalCrdtSect.equals("단기")){
				sb.append("단기매입자금대출").append(m_strBalItemVol).append(", 주, 입니다.");
			}else{
				sb.append(m_strBalItemVol).append(", 주, 입니다.");
			}
		}
