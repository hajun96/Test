...
입니다.
*/
public class TTS_463_2 extends ActionElementBase{
	public void doAction(String name, ActionElementData actionAPI) throws AudiumException {
		...
		String m_strContiMotgLackTms = (String) actionAPI.getSessionData("m_strContiMotgLackTms"); //담보부족회차
		m_strContiMotgLackTms = trimNum(m_strContiMotgLackTms);
		
		StringBuffer sb = new StringBuffer();
		
		if(m_strMotgKeepRate.equals("0")){
			sb.append("현재가 기준, 담보유지 비율은,  ")
			.append(", 없습니다. ");
		}else{
			sb.append("현재가 기준, 담보유지 비율은,  ")
		...
		if(m_strContiMotgLackTms.equals("0") || m_strContiMotgLackTms.equals(null) || m_strContiMotgLackTms.equals("")){
			sb.append("");
		}else{
			sb.append(", 담보부족, ")
			.append(m_strContiMotgLackTms)
			.append(", 회차, ")
			.append(", 입니다.");
		}
