...
public class TTS_520_1 extends ActionElementBase{
	...
	public void doAction(String name, ActionElementData actionAPI) throws AudiumException {
		...
		String m_strTdayLimitSrplAmt = (String) actionAPI.getSessionData("m_strTdayLimitSrplAmt"); //이체출금한도금액
		m_strTdayLimitSrplAmt = trimNum(m_strTdayLimitSrplAmt);
