...
public class TTS_112_5 extends ActionElementBase {
	public void doAction(String name, ActionElementData actionAPI) throws AudiumException {
		...
		if(m_strStockPriceFluctFlag.equals("0")){			//보합
			...
			sb.append(", 종합 주가지수는, ").append(", 기세상한인, ").append(strCurrentDotLeft).append(", 쩜, [").append(strCurrentDotRight).append("], 포인트이고 , ");
			...
			sb.append(", 종합 주가지수는, ").append(", 하한가인, ").append(strCurrentDotLeft).append(", 쩜, [").append(strCurrentDotRight).append("], 포인트이고 , ");
