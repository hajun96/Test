...
public class TTS_114_1 extends ActionElementBase{
	public void doAction(String name, ActionElementData actionAPI) throws AudiumException {
		...
		/*
		if(m_strOverTimeVol.equals("0") || m_strOverTimeVol.equals("") || m_strOverTimeVol.equals(null)){
			sb.append(", 시간외단일가, 거래량은, 없습니다.");
		}else{
			sb.append(", 시간외단일가, 거래량은, ")
			.append(m_strOverTimeVol)
			.append(", 주, 입니다.");
		}
	*/
