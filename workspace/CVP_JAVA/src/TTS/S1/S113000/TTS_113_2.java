...
public class TTS_113_2 extends ActionElementBase{
	public void doAction(String name, ActionElementData actionAPI) throws AudiumException {
		...
		if(m_strExpectFlucBit.equals("0")){			//보합
			sb.append(", 예상 코스닥 지수는, ").append(", 보합인, ").
			append(strExpectDotLeft).append(", 쩜, [").append(strExpectDotRight).append("], 포인트 , 입니다.");
		}else if(m_strExpectFlucBit.equals("1")){	//오른
			sb.append(", 예상 코스닥 지수는, ").append(strFluctDotLeft).append(", 쩜, [").append(strFluctDotRight).append("], 오른, ").
			append(strExpectDotLeft).append(", 쩜, [").append(strExpectDotRight).append("], 포인트 , 입니다.");
		}else if(m_strExpectFlucBit.equals("2")){	//상한가
			sb.append(", 예상 코스닥 지수는, ").append("상한가인").
			append(strExpectDotLeft).append(", 쩜, [").append(strExpectDotRight).append("], 포인트 , 입니다.");
		}else if(m_strExpectFlucBit.equals("3")){	//기세상승
			sb.append(", 예상 코스닥 지수는, ").append("기세상승인").
			append(strExpectDotLeft).append(", 쩜, [").append(strExpectDotRight).append("], 포인트 , 입니다.");
		}else if(m_strExpectFlucBit.equals("4")){	//기세상한
			sb.append(", 예상 코스닥 지수는, ").append("기세상한인").
			append(strExpectDotLeft).append(", 쩜, [").append(strExpectDotRight).append("], 포인트 , 입니다.");
		}else if(m_strExpectFlucBit.equals("5")){	//내린
			sb.append(", 예상 코스닥 지수는, ").append(strFluctDotLeft).append(", 쩜, [").append(strFluctDotRight).append("], 내린, ").
			append(strExpectDotLeft).append(", 쩜, [").append(strExpectDotRight).append("], 포인트 , 입니다.");
		}else if(m_strExpectFlucBit.equals("6")){	//하한가
			sb.append(", 예상 코스닥 지수는, ").append("하한가인").
			append(strExpectDotLeft).append(", 쩜, [").append(strExpectDotRight).append("], 포인트 , 입니다.");
		}else if(m_strExpectFlucBit.equals("7")){	//기세하락
			sb.append(", 예상 코스닥 지수는, ").append("기세하락인").
			append(strExpectDotLeft).append(", 쩜, [").append(strExpectDotRight).append("], 포인트 , 입니다.");
		}else if(m_strExpectFlucBit.equals("8")){	//기세하한
			sb.append(", 예상 코스닥 지수는, ").append("기세하한인").
			append(strExpectDotLeft).append(", 쩜, [").append(strExpectDotRight).append("], 포인트 , 입니다.");
