...
public class TTS_113_5 extends ActionElementBase{
	public void doAction(String name, ActionElementData actionAPI) throws AudiumException {
		...
		if(m_strStockPriceFluctFlag.equals("0")){			//보합
			sb.append(", 코스닥 주가지수는, ").append(", 보합인, ").
			append(strCurrentDotLeft).append(", 쩜, [").append(strCurrentDotRight).append("], 포인트이고 , ");
		}else if(m_strStockPriceFluctFlag.equals("1")){	//오른
			sb.append(", 코스닥 주가지수는, ").append(strFluctDotLeft).append(", 쩜, [").append(strFluctDotRight).append("], 포인트, ")
			...
			sb.append(", 코스닥 주가지수는, ").append(", 상한가인, ").
			append(strCurrentDotLeft).append(", 쩜, [").append(strCurrentDotRight).append("], 포인트이고 , ");
		}else if(m_strStockPriceFluctFlag.equals("3")){	//기세상승
			sb.append(", 코스닥 주가지수는, ").append(", 기세상승인, ").
			append(strCurrentDotLeft).append(", 쩜, [").append(strCurrentDotRight).append("], 포인트이고 , ");
		}else if(m_strStockPriceFluctFlag.equals("4")){	//기세상한
			sb.append(", 코스닥 주가지수는, ").append(", 기세상한인, ").
			append(strCurrentDotLeft).append(", 쩜, [").append(strCurrentDotRight).append("], 포인트이고 , ");
			...
			sb.append(", 코스닥 주가지수는, ").append(", 하한가인, ").
			append(strCurrentDotLeft).append(", 쩜, [").append(strCurrentDotRight).append("], 포인트이고 , ");
		}else if(m_strStockPriceFluctFlag.equals("7")){	//기세하락
			sb.append(", 코스닥 주가지수는, ").append(", 기세하락인, ").
			append(strCurrentDotLeft).append(", 쩜, [").append(strCurrentDotRight).append("], 포인트이고 , ");
		}else if(m_strStockPriceFluctFlag.equals("8")){	//기세하한
			sb.append(", 코스닥 주가지수는, ").append(", 기세하한인, ").
			append(strCurrentDotLeft).append(", 쩜, [").append(strCurrentDotRight).append("], 포인트이고 , ");
