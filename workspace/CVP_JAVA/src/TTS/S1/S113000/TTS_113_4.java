...
public class TTS_113_4 extends ActionElementBase{
	public void doAction(String name, ActionElementData actionAPI) throws AudiumException {
		//m_strStockPriceFluctFlag 전일대비구분
		//m_strStockPriceFluctAmt 전일대비
		//m_strStockPriceCurrentAmt 현재가
		...
		if(m_strStockPriceFluctFlag.equals("0")){			//보합
			...
			.append(", 쩜, [").append(strCurrentDotRight).append("], 포인트이고 , ")
			.append(", 거래량은, " )
			.append(m_strStockPriceVol).append(", 주, ")
			.append(", 입니다.");
		}else if(m_strStockPriceFluctFlag.equals("1")){	//오른
			sb.append(", 코스닥지수는")
			.append(strFluctDotLeft)
			.append(", 쩜, [").append(strFluctDotRight).append("], 포인트, ")
			.append(", 오른")
			.append(strCurrentDotLeft)
			.append(", 쩜, [").append(strCurrentDotRight).append("], 포인트이고 , ")
			.append(", 거래량은, " )
			.append(m_strStockPriceVol)
			.append(", 주, ").append(", 입니다.");
		}else if(m_strStockPriceFluctFlag.equals("2")){	//상한가
			sb.append(", 코스닥지수는, ").append(", 상한가인, ").
			append(strCurrentDotLeft).append(", 쩜, [").append(strCurrentDotRight).append("], 포인트이고 , ")
			.append(" ,거래량은, " ).append(m_strStockPriceVol).append(", 주, ").append(", 입니다.");
		}else if(m_strStockPriceFluctFlag.equals("3")){	//기세상승
			sb.append(", 코스닥지수는, ").append(", 기세상승인, ").
			append(strCurrentDotLeft).append(", 쩜, [").append(strCurrentDotRight).append("], 포인트이고 , ")
			.append(", 거래량은, " ).append(m_strStockPriceVol).append(", 주, ").append(", 입니다.");
		}else if(m_strStockPriceFluctFlag.equals("4")){	//기세상한
			sb.append(", 코스닥지수는, ").append(", 기세상한인, ").
			append(strCurrentDotLeft).append(", 쩜, [").append(strCurrentDotRight).append("], 포인트이고 , ")
			.append(", 거래량은, " ).append(m_strStockPriceVol).append(", 주, ").append(", 입니다., ");
		}else if(m_strStockPriceFluctFlag.equals("5")){	//내린
			sb.append(", 코스닥지수는, ").append(strFluctDotLeft).append(", 쩜, [").append(strFluctDotRight).append("], 포인트, ")
			...
			sb.append(", 코스닥지수는, ").append(", 하한가인, ").
			append(strCurrentDotLeft).append(", 쩜, [").append(strCurrentDotRight).append("], 포인트이고 , ")
			.append(", 거래량은, " ).append(m_strStockPriceVol).append(", 주, ").append(", 입니다., ");
		}else if(m_strStockPriceFluctFlag.equals("7")){	//기세하락
			sb.append(", 코스닥지수는, ").append(", 기세하락인, ").
			append(strCurrentDotLeft).append(", 쩜, [").append(strCurrentDotRight).append("], 포인트이고 , ")
			.append(", 거래량은, " ).append(m_strStockPriceVol).append(", 주, ").append(", 입니다.");
		}else if(m_strStockPriceFluctFlag.equals("8")){	//기세하한
			sb.append(", 코스닥지수는, ").append(", 기세하한인, ").
			append(strCurrentDotLeft).append(", 쩜, [").append(strCurrentDotRight).append("], 포인트이고 , ")
			.append(", 거래량은, " ).append(m_strStockPriceVol).append(", 주, ").append(", 입니다., ");
		}else if(m_strStockPriceFluctFlag.equals("9")){	//거래없음
			sb.append(", 코스닥지수는").append("보합인, ").
			append(strCurrentDotLeft).append(", 쩜, [").append(strCurrentDotRight).append("], 포인트이고 , ").append("거래량은, " )
			.append(m_strStockPriceVol).append(", 주, ").append("입니다.");
		}else{
