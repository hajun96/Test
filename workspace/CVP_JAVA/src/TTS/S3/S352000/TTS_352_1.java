...
public class TTS_352_1 extends ActionElementBase {
		...
		if(table != null && !table.isEmpty()){
			...
			try{
				...
				for(int i=0; i<CNT; i++){
					...
					String m_strBlqty = (String) table.get("A"+String.valueOf(i)+"_"+"Blqty"); //잔고수량 
					m_strBlqty = trimNum(m_strBlqty);
					Float f_m_strBlqty = Float.parseFloat(m_strBlqty);
