...
public class TTS_221000_4 extends ActionElementBase{
	public void doAction(String name, ActionElementData actionAPI) throws AudiumException {
		...
		if(m_strStockPriceFluctFlag3.equals("0")){			//보합
			sb.append(", 보합인 , ")
			.append(strCurrentDotLeft3).append(", 쩜 , [").append(strCurrentDotRight3).append("], 포인트  , ").append(", 입니다. ");
		}else if(m_strStockPriceFluctFlag3.equals("1")){	//오른
			sb.append(strFluctDotLeft3).append(", 쩜, [").append(strFluctDotRight3).append("], 포인트, ")
			.append(", 오른  , ")
			.append(strCurrentDotLeft3).append(", 쩜 , [").append(strCurrentDotRight3).append("], 포인트 , 입니다.");
