...
public class TTS_270_5 extends ActionElementBase{
	public void doAction(String name, ActionElementData actionAPI) throws AudiumException {
		String m_strFrgTrd3 = (String) actionAPI.getSessionData("m_strFrgTrd3"); //외국인매매
		String m_strAgcyTrd3 = (String) actionAPI.getSessionData("m_strAgcyTrd3"); //기관매매
		String m_strGenTrd3 = (String) actionAPI.getSessionData("m_strGenTrd3"); //일반매매
