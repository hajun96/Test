package TTS.S2.S234000;

import com.audium.server.AudiumException;
import com.audium.server.session.ActionElementData;
import com.audium.server.voiceElement.ActionElementBase;

public class TTS_234_1 extends ActionElementBase{
	public void doAction(String name, ActionElementData actionAPI) throws AudiumException {
		...
		if(m_strExpectFlucBit.equals("0")){			//보합
			sb.append(", 일본니케이지수는, ").append(", 보합인, ").append(", , ").
			...
			sb.append(", 일본니케이지수는, ").append(", , ").append(strFluctDotLeft).append(", , ").append(", 쩜, ").append(", , [").append(strFluctDotRight).append("], , ").append(", 포인트 오른, ").
			...
			sb.append(", 일본니케이지수는, ").append(", 상한가인, ").append(", , ").
			append(strExpectDotLeft).append(", , ").append(", 쩜 , ").append(", , [").append(strExpectDotRight).append("], , ").append(", 포인트 입니다.");
		}else if(m_strExpectFlucBit.equals("3")){	//기세상승
			sb.append(", 일본니케이지수는, ").append(", 기세상승인, ").append(", , ").
			append(strExpectDotLeft).append(", , ").append(", 쩜 , ").append(", , [").append(strExpectDotRight).append("], , ").append(", 포인트 입니다.");
		}else if(m_strExpectFlucBit.equals("4")){	//기세상한
			sb.append(", 일본니케이지수는, ").append(", 기세상한인, ").append(", , ").
			append(strExpectDotLeft).append(", , ").append(", 쩜 , ").append(", , [").append(strExpectDotRight).append("], , ").append(", 포인트 입니다.");
		}else if(m_strExpectFlucBit.equals("5")){	//내린
			sb.append(", 일본니케이지수는, ").append(", , ").append(strFluctDotLeft).append(", , ").append(", 쩜, ").append(", , [").append(strFluctDotRight).append("], , ").append(", 포인트 내린, ").append(", , ").
			append(", , ").append(strExpectDotLeft).append(", , ").append(", 쩜 , ").append(", , [").append(strExpectDotRight).append("], , ").append(", 포인트 입니다");
		}else if(m_strExpectFlucBit.equals("6")){	//하한가
			sb.append(", 일본니케이지수는, ").append(", 하한가인, ").append(", , ").
			append(strExpectDotLeft).append(", , ").append(", 쩜 , ").append(", , [").append(strExpectDotRight).append("], , ").append(", 포인트 입니다.");
		}else if(m_strExpectFlucBit.equals("7")){	//기세하락
			sb.append(", 일본니케이지수는, ").append(", 기세하락인, ").append(", , ").
			append(strExpectDotLeft).append(", , ").append(", 쩜 , ").append(", , [").append(strExpectDotRight).append("], , ").append(", 포인트 입니다.");
		}else if(m_strExpectFlucBit.equals("8")){	//기세하한
			sb.append(", 일본니케이지수는, ").append(", 기세하한인, ").append(", , ").
			append(strExpectDotLeft).append(", , ").append(", 쩜 , ").append(", , [").append(strExpectDotRight).append("], , ").append(", 포인트 입니다.");
		}else if(m_strExpectFlucBit.equals("9")){	//거래없음
			sb.append(", 일본니케이지수는, ").append(", 보합, 인").append(", , ").
			append(strExpectDotLeft).append(", , ").append(", 쩜 , ").append(", , [").append(strExpectDotRight).append("], , ").append(", 포인트 입니다.");
		}else{
