...
public class TTS_260_4 extends ActionElementBase{
	public void doAction(String name, ActionElementData actionAPI) throws AudiumException {
		...
		String m_strOverTimeOfferVol = (String) actionAPI.getSessionData("m_strOverTimeOfferVol"); //시간외단일가 매도잔량
		Float f_m_strOverTimeOfferVol = Float.parseFloat(m_strOverTimeOfferVol);
		m_strOverTimeOfferVol = trimNum(m_strOverTimeOfferVol);
		String m_strOverTimeBidVol = (String) actionAPI.getSessionData("m_strOverTimeBidVol"); //시간외단일가 매수잔량
		Float f_m_strOverTimeBidVol = Float.parseFloat(m_strOverTimeBidVol);
		m_strOverTimeBidVol = trimNum(m_strOverTimeBidVol);
		
		StringBuffer sb = new StringBuffer();
		
		sb.append(", 정규시장 종가대비 ,");   // 종목명
		...
		if(f_m_strOverTimeVol > 0.0){ // 시간외단일가 거래량 m_strOverTimeVol
			sb.append(", 시간외단일가, ")
			.append(", 거래량은, ")
		...
		if(f_m_strOverTimeOfferVol > 0.0){  // 시간외단일가 매도잔량 m_strOverTimeOfferVol
			sb.append(", 시간외단일가, ")
			.append(", 매도잔량은, ")
			.append(m_strOverTimeOfferVol).append(", ,")
			.append(", 주, 입니다., ");
		...
		if(f_m_strOverTimeBidVol > 0.0){ // 시간외단일가 매수잔량 m_strOverTimeBidVol
			sb.append(", 시간외단일가, ")
			.append(", 매수잔량은, ")
			.append(m_strOverTimeBidVol).append(", ,")
			.append(", 주, ")
			.append(", 입니다., ");
