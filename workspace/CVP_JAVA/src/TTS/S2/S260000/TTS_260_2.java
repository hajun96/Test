...
public class TTS_260_2 extends ActionElementBase{
	public void doAction(String name, ActionElementData actionAPI) throws AudiumException {
		...
		String m_strExpectVolume = (String) actionAPI.getSessionData("m_strExpectVolume"); // 예상 거래량
		...
		if(m_strExpectFlucBit.equals("0")){			//보합
			...
			sb.append(", 예상가는, ")
			.append(m_strExpectFluctAmt).append(", , ")
			.append(", 원, ")
			.append(", 오른, ")
			.append(m_strExpectAmt).append(", , ")
			.append(", 원, ")
		...
		if(f_m_strExpectVolume > 0.0){
			sb.append(", 예상 거래량은, ")
			.append(m_strExpectVolume).append(", , ")
			.append(", 주, ")
			.append(", 입니다., ");
