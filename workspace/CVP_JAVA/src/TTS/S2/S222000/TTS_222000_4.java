...
public class TTS_222000_4 extends ActionElementBase{
	...
	public void doAction(String arg0, ActionElementData actionAPI)
		...
		if(m_strStockPriceJobTime.length() > 4) {
			String hour = m_strStockPriceJobTime.substring(0, 2);
			String minute = m_strStockPriceJobTime.substring(2, 4);
			
			hour = convertHour(hour);
			
			sb.append(hour).append(",").append(minute).append("분, 현재");
		}
		...
		sb.append(m_strStockPriceCurrentAmt_1).append(",쩜,[").append(m_strStockPriceCurrentAmt_2).append("] 포인트 입니다.");
