...
public class TTS_222_5 extends ActionElementBase {
	public void doAction(String name, ActionElementData actionAPI) throws AudiumException {
		String m_strStockPriceFluctFlag3 = (String) actionAPI.getSessionData("m_strStockPriceFluctFlag3");        //코스닥 주가지수 전일대비구분
		...
		m_strStockPriceTrdAmt3 = m_lStockPriceTrdAmt3.toString();
		...
		if(m_strStockPriceFluctFlag0.equals("0")){			//보합
			sb.append(", 보합인 , ")
			.append(strCurrentDotLeft0).append(", 쩜 , [").append(strCurrentDotRight0).append("], 포인트로  , ").append(", 금일 장마감 되었습니다.,");
