...
public class TTS_251_1 extends ActionElementBase{
	public void doAction(String name, ActionElementData actionAPI) throws AudiumException {
		String m_strGiftYear = (String) actionAPI.getSessionData("m_strGiftYear"); //년 
		String year = m_strGiftYear.substring(0, 4);
		...
		if(m_strGiftPrevAmt != null && !m_strGiftPrevAmt.isEmpty()){
			...
			sb.append(", 코스피 200 , ").append(year).append(", , ").append(", 년 , ")
			.append(month).append(", , ").append(", 월 , ")
			.append(", 물, ").append(", , ")
			.append(", 행사가격, ")
			.append(strDotLeft).append(", , ").append(" , 쩜 , [")
			.append(strDotRight).append("], , ").append(" , 콜옵션 , ").append(" , 전일종가는 , ").append(strDotLeft1).append(", , ").append(" , 쩜 , [").append(strDotRight1)
