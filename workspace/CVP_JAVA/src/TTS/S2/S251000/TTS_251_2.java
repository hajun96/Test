...
public class TTS_251_2 extends ActionElementBase{
	public void doAction(String name, ActionElementData actionAPI) throws AudiumException {
		...
		if(m_strGiftFluctFlag.equals("0") || m_strGiftFluctFlag.equals("1") || m_strGiftFluctFlag.equals("5")){
			if(m_strGiftFluctAmt.equals("0") || m_strGiftFluctAmt.equals("") || m_strGiftFluctAmt.equals(null)){
				sb.append("");
			}else{
				// [전일 대비 계산] 
				// 소수점 자리수를 가져온다. 
				...
				if(strFluctDotRight.equals("00") || strFluctDotRight.equals("0")){
		...
		//현재가
		if(m_strGiftCurrentAmt.equals("0") || m_strGiftCurrentAmt.equals("") || m_strGiftCurrentAmt.equals(null)){
			sb.append(", 현재가 없고,");
		}else{
			// [현재가 계산]
			// 소수점 자리수를 가져온다. 
			...
			if(strCurrentDotRight.equals("00") || strCurrentDotRight.equals("0")){
		...
		if(m_strGiftOfferAmt.equals("0") || m_strGiftOfferAmt.equals("") || m_strGiftOfferAmt.equals(null)){
			sb.append(", 매도호까, ")
			.append(", 없고, ");
		}else{
			...
			if(strGiftOfferDotRight.equals("00") || strGiftOfferDotRight.equals("0")){
				sb.append(", 매도호까, ")
		...
		if(m_strGiftBidAmt.equals("0") || m_strGiftBidAmt.equals("") || m_strGiftBidAmt.equals(null)){
			sb.append(", 매수호까, ")
			.append(", 없고, ");
		}else{
			...
			if(strGiftBidDotRight.equals("00")){
				sb.append(", 매수호까, ")
		...
		//시가 m_strGiftOpenAmt
		if(m_strGiftOpenAmt.equals("0") || m_strGiftOpenAmt.equals("") || m_strGiftOpenAmt.equals(null)){
			sb.append(", 시까, ")
			.append(", 없고, ");
		}else{
			...
			if(strGiftOpenDotRight.equals("00") || strGiftOpenDotRight.equals("0")){
				sb.append(", 시까, ")
		...
		//고가  m_strGiftHighAmt
		if(m_strGiftHighAmt.equals("0") || m_strGiftHighAmt.equals("") || m_strGiftHighAmt.equals(null)){
			sb.append(", 고까, ")
			.append(", 없고, ");
		}else{
			...
			if(strGiftHighDotRight.equals("00") || strGiftHighDotRight.equals("0")){
				sb.append(", 고까, ")
		...
		//저가 m_strGiftLowAmt
		if(m_strGiftLowAmt.equals("0") || m_strGiftLowAmt.equals("") || m_strGiftLowAmt.equals(null)){
			sb.append(", 저까, ")
			.append("없습니다.");
		}else{
			...
			if(strGiftLowDotRight.equals("00") || strGiftLowDotRight.equals("0")){
				sb.append(", 저까, ")
		...
		//우선매도호까잔량	m_strGiftDiffOfferAmt4
		if(m_strGiftDiffOfferAmt4.equals("0") || m_strGiftDiffOfferAmt4.equals("") || m_strGiftDiffOfferAmt4.equals(null)){
			sb.append(", 우선, ")
			.append(", 매도호까 잔량은, ")
			.append(", 없고, ");
		}else{
			...
			if(strGiftDiffOfferAmt4DotRight.equals("00") || strGiftDiffOfferAmt4DotRight.equals("0")){
				sb.append(", 우선, ")
				.append(", 매도호까 잔량은, ")
		...
		//우선매수호까잔량	m_strGiftDiffBidAmt0
		if(m_strGiftDiffBidAmt0.equals("0") || m_strGiftDiffBidAmt0.equals("") || m_strGiftDiffBidAmt0.equals(null)){
			sb.append(", 우선, ")
			.append(", 매수호까 잔량은, ")
			.append(", 없고, ");
		}else{
			...
			if(strGiftDiffBidAmt0DotRight.equals("00") || strGiftDiffBidAmt0DotRight.equals("0")){
				sb.append(", 우선, ")
				.append(", 매수호까 잔량은, ")
		...
		//차선매도호까잔량	m_strGiftDiffOfferAmt3
		if(m_strGiftDiffOfferAmt3.equals("0") || m_strGiftDiffOfferAmt3.equals("") || m_strGiftDiffOfferAmt3.equals(null)){
			sb.append(", 차선, ")
			.append(", 매도호까 잔량은, ")
			.append(", 없고, ");
		}else{
			...
			if(strGiftDiffOfferAmt3DotRight.equals("00") || strGiftDiffOfferAmt3DotRight.equals("0")){
				sb.append(", 차선, ")
				.append(", 매도호까 잔량은, ")
		...
		//차선매수호까잔량	m_strGiftDiffBidAmt1
		if(m_strGiftDiffBidAmt1.equals("0") || m_strGiftDiffBidAmt1.equals("") || m_strGiftDiffBidAmt1.equals(null)){
			sb.append(", 차선, ")
			.append(", 매수호까 잔량은, ")
			.append(", 없고, ");
		}else{
			...
			if(strGiftDiffBidAmt1DotRight.equals("00") || strGiftDiffBidAmt1DotRight.equals("0")){
				sb.append(", 차선, ")
				.append(", 매수호까 잔량은, ")
