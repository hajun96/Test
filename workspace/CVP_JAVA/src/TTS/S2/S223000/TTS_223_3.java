...
public class TTS_223_3 extends ActionElementBase{
	...
	public void doAction(String arg0, ActionElementData actionAPI)
		...
		sb.append(", 코스피 200  지수는 전일대비,")
		.append(m_strStockPriceCurrentAmt_1).append(",쩜,[").append(m_strStockPriceCurrentAmt_2).append("] 포인트로,");
